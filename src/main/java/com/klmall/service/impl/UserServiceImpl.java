...
import com.klmall.common.TokenCache;
import com.klmall.dao.UserMapper;
import com.klmall.pojo.User;
import com.klmall.service.IUserService;
import com.klmall.util.MD5Util;
...
public class UserServiceImpl implements IUserService{
    ...
    public ServerResponse<String> selectQuestion(String username){
        ...
        return ServerResponse.createByErrorMessage("查找密码提示问题失败");
    }
    ...
    public ServerResponse<String> forgetResetPassword(String username, String passwordNew, String forgetToken){
        if (StringUtils.isBlank(forgetToken)){
            return ServerResponse.createByErrorMessage("参数错误，token");
        }
        ServerResponse validResponse = this.checkValid(username, Const.USERNAME);
        if(validResponse.isSuccess()){
            //用户已存在
